...
4. Tambahkan atribut ukuran atau kelas CSS yang konsisten (contoh: `width="300"` atau class `.foto-kegiatan`) sehingga gambar otomatis menyesuaikan grid/tata letak yang sudah ada.
